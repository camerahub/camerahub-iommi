...
#    path('enlargermodel/create/', views.EnlargerModelCreate.as_view(), name='enlargermodel-create'),
...
#    path('flashmodel/create/', views.FlashModelCreate.as_view(), name='flashmodel-create'),
...
#    path('teleconvertermodel/create/', views.TeleconverterModelCreate.as_view(), name='teleconvertermodel-create'),
